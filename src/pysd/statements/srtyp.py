...
class SRTYP(StatementBase):
    ...
    mp: Optional[float] = Field(None, description="material property set (see RMPNS statement)")
    # Method 1 (direct area input):
    ...
    di: Optional[float] = Field(None, description="shear reinforcement diameter (also input if MCFT is used as design code [mm}])")
    c1: Optional[float] = Field(None, description="bar distance direction 1 [mm] (Method 2)")
    c2: Optional[float] = Field(None, description="bar distance direction 2 [mm] (Method 2)")
