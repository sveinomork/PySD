...
class RMPOS(StatementBase):
    """
    define rebar material property sets according to DNV-ST-C502. 
    The ID number is related to the MP statement in the RETYP statement. 
