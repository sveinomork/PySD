...
class TETYP(StatementBase):
    ...
    #optional parameters
    mp: Optional[int] = Field(None, description="material property set (see TEMAT statement)")
    ...
    os: Optional[float] = Field(None, description="face 1/2: distance concrete face-layer center face 0: x3-coordinate layer centre [mm]")
