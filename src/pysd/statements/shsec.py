...
class SHSEC(StatementBase):
    ...
    xp: Optional[Tuple[float, float, float]] = Field(
        None, description="Start element coordinates"
    )
    ...
    td: Optional[Tuple[float, float, float]] = Field(
        None, description="Thickness direction vector"
    )
    xf: Optional[Tuple[float, float, float]] = Field(
        None, description="F-direction start vector"
    )
    xh: Optional[Tuple[float, float, float]] = Field(
        None, description="H-direction start vector"
    )
    ...
    ne: Optional[int] = Field(
        None, description="Number of elements over thickness (max 10)"
    )
