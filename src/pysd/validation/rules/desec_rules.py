...
@instance_rule("DESEC")
def validate_desec_instance(
    statement: "DESEC", context: "ValidationContext"
...
def validate_desec_container(
    container: "BaseContainer[DESEC]", context: "ValidationContext"
) -> List[ValidationIssue]:
