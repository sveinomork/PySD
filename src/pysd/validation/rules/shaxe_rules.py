...
@instance_rule('SHAXE')
def validate_shaxe_pa_required(obj: 'SHAXE', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('SHAXE')
def validate_shaxe_mode_exclusive(obj: 'SHAXE', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('SHAXE')
def validate_shaxe_section_ranges(obj: 'SHAXE', context: ValidationContext) -> List[ValidationIssue]:
...
def validate_shaxe_uniqueness(obj: 'SHAXE', context: ValidationContext) -> List[ValidationIssue]:
