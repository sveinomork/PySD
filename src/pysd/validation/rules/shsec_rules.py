...
@instance_rule('SHSEC')
def validate_shsec_pa_format(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('SHSEC')
def validate_shsec_element_specification(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('SHSEC')
def validate_shsec_ne_range(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('SHSEC')
def validate_shsec_section_ranges(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
...
def validate_shsec_uniqueness(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
    ...
    if context.parent_container and hasattr(obj, 'key'):
        ...
        if any(getattr(item, 'key', None) == obj.key for item in context.parent_container.items):
            issues.append(ValidationIssue(
                severity=ValidationSeverity.ERROR.value,
                code="SHSEC-DUP-001",
...
@model_rule('SHSEC')
def validate_shsec_part_consistency(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
...
@model_rule('SHSEC')
def validate_shsec_super_element_reference(obj: 'SHSEC', context: ValidationContext) -> List[ValidationIssue]:
