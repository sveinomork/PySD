...
@instance_rule('TEMAT')
def validate_temat_id_range(obj: 'TEMAT', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('TEMAT')
def validate_temat_positive_values(obj: 'TEMAT', context: ValidationContext) -> List[ValidationIssue]:
...
def validate_temat_uniqueness(obj: 'TEMAT', context: ValidationContext) -> List[ValidationIssue]:
