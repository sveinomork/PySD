...
def validate_depar_parameters(obj: 'DEPAR') -> List[ValidationIssue]:
    ...
    for tol_name, tol_value in [('t_tol', obj.t_tol), ('p_tol', obj.p_tol), ('z_tol', obj.z_tol)]:
...
@model_rule('DEPAR')
def validate_depar_model_consistency(obj: 'DEPAR', context: ValidationContext) -> List[ValidationIssue]:
