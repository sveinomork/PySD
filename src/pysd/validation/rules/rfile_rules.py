...
@instance_rule('RFILE')
def validate_rfile_file_existence(obj: 'RFILE', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('RFILE')
def validate_rfile_fnm_format(obj: 'RFILE', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('RFILE')
def validate_rfile_file_dependencies(obj: 'RFILE', context: ValidationContext) -> List[ValidationIssue]:
...
@instance_rule('RFILE')
def validate_rfile_unit_factors(obj: 'RFILE', context: ValidationContext) -> List[ValidationIssue]:
...
@model_rule('RFILE')
def validate_rfile_uniqueness(obj: 'RFILE', context: ValidationContext) -> List[ValidationIssue]:
