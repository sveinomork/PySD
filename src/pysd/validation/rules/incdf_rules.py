...
@instance_rule("FILST")
def validate_filst_parameter_exclusivity(
    obj: "FILST", context: ValidationContext
...
@instance_rule("FILST")
def validate_filst_field_lengths(
    obj: "FILST", context: ValidationContext
) -> List[ValidationIssue]:
...
@instance_rule("FILST")
def validate_filst_field_content(
    obj: "FILST", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("FILST")
def validate_filst_model_consistency(
    obj: "FILST", context: ValidationContext
) -> List[ValidationIssue]:
    ...
    if obj.name is not None:
        other_names = [
            getattr(f, "name", None)
            for f in other_filsts
            if not getattr(f, "pri", False)
        ]
