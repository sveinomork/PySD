...
@instance_rule("CASES")
def validate_cases_bas_ids(
    obj: "CASES", context: ValidationContext
...
@instance_rule("CASES")
def validate_cases_text_length(
    obj: "CASES", context: ValidationContext
) -> List[ValidationIssue]:
...
def validate_cases_bas_overlap(
    obj: "CASES", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("CASES")
def validate_cases_bas_references_exist(
    obj: "CASES", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("CASES")
def validate_cases_basco_dependencies(
    obj: "CASES", context: ValidationContext
) -> List[ValidationIssue]:
