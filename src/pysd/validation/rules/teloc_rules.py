...
@instance_rule('TELOC')
def validate_teloc_instance(statement: 'TELOC', context: 'ValidationContext') -> List[ValidationIssue]:
...
def validate_teloc_container(container: 'BaseContainer[TELOC]', context: 'ValidationContext') -> List[ValidationIssue]:
...
@model_rule('TELOC')
def validate_reloc_model(statement: 'TELOC', context: 'ValidationContext') -> List[ValidationIssue]:
