...
@instance_rule("BASCO")
def validate_basco_id_range(
    obj: "BASCO", context: ValidationContext
...
@instance_rule("BASCO")
def validate_basco_load_cases_count(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
...
@instance_rule("BASCO")
def validate_basco_text_length(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
...
@instance_rule("BASCO")
def validate_load_factor_ranges(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("BASCO")
def validate_bas_references_exist(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("BASCO")
def validate_elc_references_exist(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("BASCO")
def validate_olc_references_exist(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
...
@model_rule("BASCO")
def validate_no_circular_bas_references(
    obj: "BASCO", context: ValidationContext
) -> List[ValidationIssue]:
