...
@instance_rule('LORES')
def validate_lores_instance(statement: 'LORES', context: 'ValidationContext') -> List[ValidationIssue]:
...
@model_rule('LORES')
def validate_lores_model(statement: 'LORES', context: 'ValidationContext') -> List[ValidationIssue]:
