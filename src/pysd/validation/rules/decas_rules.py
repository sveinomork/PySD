...
@instance_rule('DECAS')
def validate_decas_instance(statement: 'DECAS', context: 'ValidationContext') -> List[ValidationIssue]:
...
def validate_decas_container(container, context: 'ValidationContext') -> List[ValidationIssue]:
...
@model_rule('DECAS')
def validate_decas_model(statement: 'DECAS', context: 'ValidationContext') -> List[ValidationIssue]:
    ...
    if referenced_load_cases:
        ...
        missing_cases = [lc for lc in referenced_load_cases if lc not in defined_load_cases]
