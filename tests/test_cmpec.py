...
def test_cmpec_full():
    ...
    cmpec = CMPEC(
        id=2, gr="B40", rh=1250.0, fck=40000.0, ecm=30000.0, fcn=35000.0,
        ftm=3000.0, acc=0.9, exp=0.3, ec2=2000.0, ecu=0.0035,
        mfu=1.4, mfa=1.1, mfs=1.0, k1c=0.16, k1t=0.32, k2=0.14,
        cot=2.6, tsp=120, tsd=1.1,
