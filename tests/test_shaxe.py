...
def test_shaxe_basic():
    ...
    assert shaxe.input == "SHAXE PA=PLATE X1=1.0,0.0,0.0 X2=0.0,1.0,0.0 X3=0.0,0.0,1.0"
...
def test_shaxe_model():
    ...
    assert model.shaxe[0].input == "SHAXE PA=PLATE X1=1.0,0.0,0.0 X2=0.0,1.0,0.0 X3=0.0,0.0,1.0"
